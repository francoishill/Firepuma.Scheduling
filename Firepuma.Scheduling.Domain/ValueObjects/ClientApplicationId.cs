...
namespace Firepuma.Scheduling.Domain.ValueObjects;
...
public readonly struct ClientApplicationId : IComparable<ClientApplicationId>, IEquatable<ClientApplicationId>
{
    ...
    public bool Equals(ClientApplicationId other) => Value.Equals(other.Value);
    ...
    private class ClientApplicationIdMongoSerializer : SerializerBase<ClientApplicationId>
    {
        ...
        public override void Serialize(BsonSerializationContext context, BsonSerializationArgs args, ClientApplicationId value)
        {
